...
import arboDeSeda.backend.Infraestructura.Filtros.FiltroTokenSeguridad;
...
public class ConfiguracionesSeguridad {
    ...
    @Autowired
    private final FiltroTokenSeguridad filtroTokenSeguridad;

    public ConfiguracionesSeguridad(FiltroTokenSeguridad filtroTokenSeguridad) {
        this.filtroTokenSeguridad = filtroTokenSeguridad;
    }
